...
class WriteOffer
{
	...
	public function updateOffer($offerId,$offerPrice,$offerQ = 1) {
		$result = array();
	...
	public function updateProps($element_id,$props) {
		CIBlockElement::SetPropertyValuesEx($element_id, $this->param['IBLOCK_ID'], $props);
	}
